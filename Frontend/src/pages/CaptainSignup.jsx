...
const CaptainSignup = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col  justify-between'>
        ...
        <div>
          <Link to='/login' className='bg-[#785006] text-white  font-semibold mb-7 rounded px-4 py-2  w-full text-lg placeholder:text-base flex justify-center items-center'>
            Sign in as User
          </Link>
